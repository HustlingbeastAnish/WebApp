          ...
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                ...
                corrective action and enforce attendance policies.
              </p>
            </div>
            <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
            ...
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
               provide a dedicated query feature, which allows employees to raise queries regarding their attendance data. The app should allow employees to attach evidence, such as a doctor's note or a screenshot of their attendance data, to support their query.
            </div>
            <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                <svg
