        ...
        <div className="container px-6 py-12 h-full">
          <div className="flex items-center h-full text-gray-800 ">
            <div className="border-black border-[4px] p-10 rounded-xl bg-gray-400">
              ...
              <form method="POST">
                <div className="mb-6 w-2/3" id="email">
                  <input
                    type="text"
                    className="form-control block w-fulls px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
