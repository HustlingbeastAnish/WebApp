        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <div className="flex justify-evenly items-center">
              <div>
                <h2 className="font-semibold text-white">Login as Teacher</h2>
                <Link to="/loginteach">
                  <button
                    type="submit"
                    className="block w-28 font-extrabold bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2"
                  >
                    Login
                  </button>
                </Link>
              ...
              <div>
                <h2 className="font-semibold text-white">Login as Student</h2>
                <Link to="/loginstud">
                  <button
                    type="submit"
