              ...
              <div className="block p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
                <div className="flex justify-between mb-4 ">
                  <label
                    ...
                    className="form-label text-white text-2xl md:text-sm font-extrabold inline-block "
                  >
                    CREATE NEW STUDENT
                  </label>
                </div>
                <p className="text-white font-semibold mb-2 md:text-sm">
                ...
                <Link to="/createattend">
                  <button
                    type="button"
                    className="inline-block px-4 py-1.5 text-extrabold md:text-sm bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out"
            ...
            <div className="w-3/4 h-48 md:w-full md:max-w-md md:h-auto mb-4 md:mb-10">
              <div className="block p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
                <div className="flex justify-between mb-4 ">
                  <label
                    htmlFor="exampleInputPassword2"
                    className="form-label text-white text-2xl font-extrabold md:text-sm inline-block "
                  >
            ...
            <div className="w-3/4 h-48 md:w-full md:max-w-md md:h-auto mb-4 md:mb-10">
              <div className="block p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
                <div className="flex justify-between mb-4 ">
                  <label
                    htmlFor="exampleInputPassword2"
                    className="form-label text-white  md:text-sm text-2xl font-extrabold inline-block "
                  >
                    TAKE ATTENDANCE
                  </label>
                </div>
