  ...
  return (
    <div className="bg-gray-900 h-screen">
      ...
      <section className="bg-gray-900 h-screen">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto gap-4 md:py-12 md:grid-cols-8 lg:py-16 lg:grid-cols-12">
          ...
          <div className="mt-20 lg:mt-0 lg:col-span-5 lg:flex justify-center items-center">
            <img
              src={Landing2}
              className=" h-auto sm:w-48 md:w-72 lg:w-92  xl:w-216 rounded-30px"
              // className="w-108"
              alt="mockup"
            />
          </div>
