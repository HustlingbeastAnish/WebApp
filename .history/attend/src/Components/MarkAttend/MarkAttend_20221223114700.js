...
function MarkAttend() {
  const arrCon = useContext(TeacherQueries);

  return (
    <>
      <TeacherQueries.Consumer>
        <div className="bg-gray-400 border-black">
          <h2 className="text-center font-semibold font-siez ">
            {" "}
            Welcome XYZ ..{" "}
          </h2>
          <h2>Your queries are {arrCon.Subject}</h2>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                ...
                /> */}
                  ...
                  <td className="py-4 px-6">Electronics and Communication</td>
