...
function tlogin() {
  return (
    <div>
      <div class="bg-gray-200 dark:bg-gray-800 flex">
        <div class="container flex items-center px-6 py-4  overflow-y-auto whitespace-nowrap">
        ...
        <button class="mr-8 group relative h-10 w-48 overflow-hidden rounded-lg bg-white text-lg shadow">
      ...
      <br></br>
      <br></br>
      <h3 class="text-2xl   display: inline-block  text-gray-700 font-bold mb-6 ml-10 content-center ...">
        WELCOME ..............@TEACHER
      </h3>

      <br></br>
      <br></br>
      <ol class=" ml-5 flex items-start ...">
