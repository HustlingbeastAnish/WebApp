    ...
    <div className="bg-gray-900 h-screen">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="row row-cols-2 row-cols-sm-3 row-cols-md-4">
          <div className="block p-6 rounded-lg  w-3/4 shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
          ...
          <div className="block w-3/4 p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
            <div className="flex justify-between mb-4">
              <label
                htmlFor="exampleInputPassword2"
                className="form-label text-white text-2xl font-extrabold inline-block"
          ...
          <div className="block p-6 rounded-lg  md:w-3/4 shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
            <div className="flex justify-between mb-4">
              <label
                htmlFor="exampleInputPassword2"
                className="form-label text-white text-2xl font-extrabold inline-block"
