...
Added a justify-between class to the parent div container wrapping the terms and conditions and forgot password elements.
Added a ml-4 class to the forgot password link to add left margin and create some spacing from the terms and conditions text.
Adjusted the alignment and added appropriate margins and paddings to maintain the layout.
With these changes, the "Forgot password?" link should now appear on the right side of the "Accept terms and conditions" checkbox.
