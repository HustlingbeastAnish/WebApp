...
const CheckSub = (props) => {
  ...
  const [flagPie, setflagPie] = useState(false);
          ...
          <div class="flex justify-center">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              {StudSubjects.map((elem, idx) => {
                return (
                  <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 row-height">
                      <th
                        scope="row"
                        class="px-6 py-2 font-medium text-xl text-gray-900 whitespace-nowrap dark:text-white"
                      >
                        {idx}
                      </th>
                      <th
