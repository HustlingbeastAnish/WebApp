...
const Forgotpass = (props) => {
  ...
  return (
    <div>
      ...
      <div class="max-w-sm p-6 display-flex bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-center items-center">
