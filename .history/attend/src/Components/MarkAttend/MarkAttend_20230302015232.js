...
function MarkAttend(props) {
  ...
  const FetchAttendanceDetails = (stemail) => {
    axios
      .get(`http://localhost:3002/detailstloginusers/${stemail}`)
      .then((res) => {
        console.log(res.data.Data_Strctures);
      })
      .catch((err) => {
        console.log(err);
      });
                      ...
                      <label class="relative inline-flex items-center mr-5 cursor-pointer">
                        <input
                          ...
                          onClick={() => {
                            ...
                            //   console.log(arr[i]);
                            // }
                            FetchAttendanceDetails(elem.email);
                            console.log(elem);
                          }}
                        />
