...
/>
Then, in your CSS file or style block, you can define the styles for the custom label class:
...
Feel free to adjust the CSS properties and values based on your preferences to improve the appearance of the label.
