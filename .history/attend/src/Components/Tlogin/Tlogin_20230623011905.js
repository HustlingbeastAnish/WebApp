    ...
    <div className="bg-gray-900 h-screen">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="ml-5 flex flex-col">
          <div className="">
            <div className=" h-48 md:w-full sm:w-3/4 md:max-w-md md:h-auto mb-4 md:mb-10">
          ...
          <div className="">
            <div className=" h-48 md:w-full md:max-w-md md:h-auto mb-4 md:mb-10">
              <div className="block p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
                <div className="flex justify-between mb-4 ">
                  <label
                    htmlFor="exampleInputPassword2"
          ...
          <div className="">
            <div className=" h-48 sm:mt-3 md:w-full md:max-w-md md:h-auto mb-4 md:mb-10">
              <div className="block p-6 rounded-lg shadow-lg bg-gray-600 max-w-md ml-6 mb-10">
                <div className="flex justify-between mb-4 ">
                  <label
                    htmlFor="exampleInputPassword2"
