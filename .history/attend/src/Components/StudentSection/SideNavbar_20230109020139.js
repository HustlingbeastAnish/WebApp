...
function SideNavbar(props) {
  return (
    <aside class={`w-${props.open ? 64 : 14}`} aria-label="Sidebar">
      <div class="px-3 py-4 overflow-y-auto rounded bg-gray-300 dark:bg-gray-800">
        <ul class="space-y-2">
          <li>
            <a
              href="/#"
            ...
            >
              ...
              {props.open && <span class="ml-3">Dashboard</span>}
            </a>
          </li>
          <li>
            <a
